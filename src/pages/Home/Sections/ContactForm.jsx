    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#2aa05a" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              {submitted ? (
                ...
                >
                  <div style={{
                    ...
                    <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#2aa05a" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="20 6 9 17 4 12"/>
                    </svg>
                  </div>
